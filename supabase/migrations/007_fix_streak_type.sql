-- Fix: update_daily_streak declares p_user_id as UUID but profiles.id is TEXT (Clerk user IDs)
CREATE OR REPLACE FUNCTION update_daily_streak(p_user_id TEXT, p_today DATE)
